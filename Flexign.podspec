...
Pod::Spec.new do |s|
  s.name             = 'Flexign'
  s.version          = '0.1.0'
  s.summary          = 'A short description of Flexign.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'tombartkowski' => 't-bartkowski@american-systems.pl' }
  s.source           = { :git => 'https://github.com/tombartkowski/Flexign.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '9.0'

  s.source_files = 'Flexign/Classes/**/*'
  
  # s.resource_bundles = {
  #   'Flexign' => ['Flexign/Assets/*.png']
  # }
